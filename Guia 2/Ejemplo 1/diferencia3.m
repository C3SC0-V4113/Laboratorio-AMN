%Este programa desarrolla la interpolación mediante difernecias divididas
%f es la función definida entre comillas
%X es un vector fila que contiene los valores de X
%Y es un vector fila que contiene los valores de la función
