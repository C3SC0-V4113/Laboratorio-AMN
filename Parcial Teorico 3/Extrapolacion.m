...
y=0;
syms t y 
ED=input('Introduzca la ecuacion diferencial : ');
cond=input('Introduzca la condicion Y(a)=b : ');
f=input('Introduzca la funcion de trabajo f(ti,wi) : ');
wo=input('Introduzca la condicion inicial wo : ');
