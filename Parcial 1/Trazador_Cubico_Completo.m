...
fprintf('El polinomio resultante es:%0.8f + (%3.8f)*(x- %0.8f)+ (%3.8f)*(x- %0.8f)^2 + (%3.8f)*(x- %0.8f)^3\n',A(cont),f,X(cont),C(cont),X(cont),o,X(cont));

fprintf('El resultado final es: %3.8f',M);
